...
with the ros_fmu development team early in the process. Coordinating up
...
```
ros_fmu Developer's Certificate of Origin.  Version 1.0
...
procedure is simple: To certify above ros_fmu Developer's Certificate of
...
If you are a developer who is authorized to contribute to ros_fmu on
